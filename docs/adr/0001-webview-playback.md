...
Mozaic needs to play YouTube Music content, including Premium tracks with DRM protection. There are several approaches to consider:
...
- **Feature parity** - Any content playable on web works in Mozaic
