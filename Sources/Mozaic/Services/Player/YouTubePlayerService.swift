...
final class YouTubePlayerService {
    ...
    /// Current surface placement. MozaicApp observes this to open/close the
    /// floating window.
    ...
    /// MozaicApp brings the app to the video source; YouTubeContentView
    ...
    /// Set once by MozaicApp; optional so unit tests don't need it.
