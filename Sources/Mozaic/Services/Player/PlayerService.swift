...
final class PlayerService: NSObject, PlayerServiceProtocol {
    ...
    /// in `MozaicApp.init()` before any AppleScript commands can be received, and is never
    ...
    static let queueDisplayModeKey = "mozaic.queue.displayMode"
    ...
    var isMozaicInitiatedPlayback: Bool = false
