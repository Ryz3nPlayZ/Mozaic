...
enum FoundationModelsPromptLibrary {
    ...
    static func commandBarInstructions(
        ...
        case .legacy26_0To26_3:
            """
            You are a music assistant for the Mozaic app. Parse the user's natural language command
        ...
        case .optimized26_4AndLater:
            """
            You are Mozaic's command-bar parser. Return the best CommandBarParseResult for the user's request.
    ...
    static func lyricsExplanationInstructions(
        ...
        case .optimized26_4AndLater:
            """
            You explain song lyrics for Mozaic. Be insightful, concrete, and accessible.
    ...
    static func queueDescriptionInstructions(
        ...
        case .legacy26_0To26_3:
            """
            You are a thoughtful music curator for the Mozaic app. Analyze the user's queue
        ...
        case .optimized26_4AndLater:
            """
            You analyze the user's current Mozaic queue like a great radio host or tastemaker.
    ...
    static func playlistRefinementInstructions(
        ...
        case .optimized26_4AndLater:
            """
            You curate playlists for Mozaic. Suggest the minimum changes needed to satisfy the request.
