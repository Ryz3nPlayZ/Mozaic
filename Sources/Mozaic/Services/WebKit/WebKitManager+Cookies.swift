...
enum KeychainCookieStorage {
    ...
    private static let service = "com.mozaic.auth-cookies"
...
enum LegacyCookieMigration {
    ...
    enum DebugCookieFileExporter {
        ...
        private static var fileURL: URL? {
            ...
            let appFolder = appSupport.appendingPathComponent("Mozaic", isDirectory: true)
            ...
            do {
                ...
                Self.logger.error("Failed to create Mozaic folder: \(error.localizedDescription)")
                return nil
            }
