...
/// Serializes to JSON in `~/Library/Application Support/Mozaic/scrobble-queue.json`.
...
final class ScrobbleQueue {
    ...
    /// - Parameter directory: Directory for queue file. Defaults to Application Support/Mozaic.
    ...
    private static func defaultDirectory() -> URL {
        ...
        return appSupport.appendingPathComponent("Mozaic")
    }
}
