...
final class LastFMService: ScrobbleServiceProtocol {
    ...
    /// Configure via `MOZAIC_LASTFM_WORKER_URL` environment variable or Info.plist.
    ...
    init(
        ...
        } else if let envURL = ProcessInfo.processInfo.environment["MOZAIC_LASTFM_WORKER_URL"],
                  ...
                  let url = URL(string: bundleURL)
        {
            ...
            self.workerBaseURL = URL(string: "https://mozaic-lastfm.Ryz3nPlayZ.workers.dev")!
        }
    }
