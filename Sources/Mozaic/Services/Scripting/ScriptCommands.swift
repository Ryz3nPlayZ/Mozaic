...
@objc(MozaicPreviousTrackCommand)
...
@objc(MozaicToggleShuffleCommand)
...
@objc(MozaicGetPlayerInfoCommand)
...
/// This is a synchronous operation.
@objc(MozaicDislikeTrackCommand)
