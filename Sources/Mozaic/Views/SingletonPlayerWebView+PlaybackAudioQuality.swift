...
extension SingletonPlayerWebView {
    static func playbackAudioQualityBootstrapScript(
        ...
        (function() {
            try {
                localStorage.setItem('mozaicPlaybackAudioQuality', '\(quality.rawValue)');
            } catch (e) {}
            window.__mozaicPlaybackAudioQuality = '\(quality.rawValue)';
        })();
        """
    }
    ...
    static func playbackAudioQualitySyncScript(
        ...
        (function() {
            ...
            window.__mozaicPlaybackAudioQuality = '\(quality.rawValue)';
            if (typeof window.__mozaicApplyPlaybackAudioQuality === 'function') {
                window.__mozaicApplyPlaybackAudioQuality();
            }
        })();
        """
    }
    ...
    static var playbackAudioQualityOverrideScript: String {
        ...
        (function() {
            ...
            function currentQuality() {
                if (typeof window.__mozaicPlaybackAudioQuality === 'string') {
                    return normalizedQuality(window.__mozaicPlaybackAudioQuality);
                }

                try {
                    return normalizedQuality(localStorage.getItem('mozaicPlaybackAudioQuality'));
                } catch (e) {
                    return 'auto';
                }
            }
            ...
            window.__mozaicApplyPlaybackAudioQuality = function() {
                ...
                window.__mozaicPlaybackAudioQuality = quality;
            ...
            function attachVideoListeners() {
                ...
                if (!v || v.__mozaicAudioQualityAttached) return;
                v.__mozaicAudioQualityAttached = true;
