...
struct ExtensionsSettingsView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Text("Extensions are loaded at launch via the native WebKit extension API. Changes take effect after restarting Mozaic.")
                        .foregroundStyle(.secondary)
        ...
        .alert("Restart Required", isPresented: self.$showRestartAlert) {
            ...
            Text("\(self.pendingChangeDescription) will take effect after restarting Mozaic.")
        }
