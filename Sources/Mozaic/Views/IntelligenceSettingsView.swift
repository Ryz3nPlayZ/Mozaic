    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("When enabled, Mozaic can add richer queue analysis, AI-powered playlist refinement, and lyrics explanations.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
            ...
            Section {
                ...
                Text("Mozaic creates fresh AI sessions per request. Refresh the status if Apple Intelligence finishes downloading or becomes available while the app is open.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        }
