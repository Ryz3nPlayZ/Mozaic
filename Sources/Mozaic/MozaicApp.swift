...
/// Main entry point for the Mozaic macOS application.
@main
    ...
    var body: some Scene {
        Window("Mozaic", id: "main") {
            ...
            if UITestConfig.isRunningUnitTests, !UITestConfig.isUITestMode {
                ...
                .onAppear {
                    DiagnosticsLogger.app.info("MozaicApp: App content appeared")
                ...
                .task {
                    DiagnosticsLogger.app.info("MozaicApp: Root task started")
                    // Check if user is already logged in from previous session
                    await self.authService.checkLoginStatus()
                    DiagnosticsLogger.app.info("MozaicApp: Login status check complete")
