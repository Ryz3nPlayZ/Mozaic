...
enum WhatsNewProvider {
    ...
    static let fallbackCollection: [WhatsNew] = [
        WhatsNew(
            ...
            learnMoreURL: URL(string: "https://github.com/Ryz3nPlayZ/Mozaic/releases")
        ),
    ]
    ...
    private static func parseRelease(data: Data) -> WhatsNew? {
        ...
        let title = name ?? "What's New in Mozaic \(versionString)"
