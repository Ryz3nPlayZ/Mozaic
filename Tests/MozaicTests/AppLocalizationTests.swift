...
struct AppLocalizationTests {
    ...
    private func sourceCatalogValue(key: String, localeIdentifier: String) throws -> String {
        ...
        let repositoryRoot = testFileURL
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
        let catalogURL = repositoryRoot.appendingPathComponent("Sources/Mozaic/Resources/Localizable.xcstrings")
    ...
    @Test("Override bundle lookup is scoped to Mozaic-owned bundles")
    func overrideBundleLookupIsScopedToMozaicBundles() throws {
