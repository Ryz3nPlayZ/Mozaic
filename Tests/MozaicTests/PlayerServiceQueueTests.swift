...
struct PlayerServiceQueueTests {
    ...
    init() {
        ...
        UserDefaults.standard.removeObject(forKey: "mozaic.saved.queue")
        UserDefaults.standard.removeObject(forKey: "mozaic.saved.queueIndex")
        UserDefaults.standard.removeObject(forKey: "mozaic.saved.playbackSession")
    ...
    func restoreInvalidQueue() {
        ...
        UserDefaults.standard.set(Data("invalid data".utf8), forKey: "mozaic.saved.queue")
        UserDefaults.standard.set(0, forKey: "mozaic.saved.queueIndex")
        UserDefaults.standard.removeObject(forKey: "mozaic.saved.playbackSession")
    ...
    func legacyQueuePersistenceFallback() throws {
        ...
        UserDefaults.standard.set(queueData, forKey: "mozaic.saved.queue")
        UserDefaults.standard.set(1, forKey: "mozaic.saved.queueIndex")
        UserDefaults.standard.removeObject(forKey: "mozaic.saved.playbackSession")
    ...
    func queueDisplayModePersistence() {
        ...
        // Assert
        let savedMode = UserDefaults.standard.string(forKey: "mozaic.queue.displayMode")
