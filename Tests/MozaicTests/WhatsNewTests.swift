...
struct WhatsNewVersionStoreTests {
    private let defaults = UserDefaults(suiteName: "com.mozaic.test.WhatsNewVersionStore")!

    init() {
        // Clean up before each test suite run
        self.defaults.removePersistentDomain(forName: "com.mozaic.test.WhatsNewVersionStore")
    }
...
struct WhatsNewProviderTests {
    private let defaults = UserDefaults(suiteName: "com.mozaic.test.WhatsNewProvider")!

    init() {
        self.defaults.removePersistentDomain(forName: "com.mozaic.test.WhatsNewProvider")
    }
    ...
    func bypassesPresentedVersionGating() async {
        ...
        MockURLProtocol.requestHandler = { request in
            ...
            if url.path == "/repos/Ryz3nPlayZ/mozaic/releases/tags/v1.0.0" {
                body = [
                    "tag_name": "v1.0.0",
                    "name": "What's New in Mozaic 1.0.0",
                    "body": "Release notes",
                    "html_url": "https://github.com/Ryz3nPlayZ/mozaic/releases/tag/v1.0.0",
                ]
                statusCode = 200
            } else {
                body = [:]
    ...
    func fetchesExactPrereleaseTag() async {
        ...
        MockURLProtocol.requestHandler = { request in
            ...
            if url.path == "/repos/Ryz3nPlayZ/mozaic/releases/tags/v1.0.0-beta.1" {
                body = [
                    "tag_name": "v1.0.0-beta.1",
                    "name": "1.0.0-beta.1",
                    "body": "Beta notes",
                    "html_url": "https://github.com/Ryz3nPlayZ/mozaic/releases/tag/v1.0.0-beta.1",
                ]
                statusCode = 200
            } else {
                body = [:]
    ...
    func extractsWhatsNewSectionFromCRLFReleaseNotes() async {
        ...
        MockURLProtocol.requestHandler = { request in
            ...
            if url.path == "/repos/Ryz3nPlayZ/mozaic/releases/tags/v1.2.3" {
                body = [
                    "tag_name": "v1.2.3",
                    "name": "What's New in Mozaic 1.2.3",
                    "body": "Star intro\r\n\r\n## What's New\r\n\r\n### Queue Enhancements\r\n\r\n- Faster queue updates\r\n\r\n## New Contributors\r\n\r\n- @new-contributor made their first contribution\r\n",
                    "html_url": "https://github.com/Ryz3nPlayZ/mozaic/releases/tag/v1.2.3",
                ]
                statusCode = 200
            } else {
                body = [:]
    ...
    func preservesContentInsideWhatsNewSection() async {
        ...
        MockURLProtocol.requestHandler = { request in
            ...
            if url.path == "/repos/Ryz3nPlayZ/mozaic/releases/tags/v0.7.0" {
                body = [
                    "tag_name": "v0.7.0",
                    "name": "What's New in Mozaic 0.7.0",
                    "body": """
                    Star intro
                    ...
                    **Fixes and improvements**
                    ...
                    - https://github.com/Ryz3nPlayZ/mozaic/compare/v0.6.0...v0.7.0
                    """,
                    "html_url": "https://github.com/Ryz3nPlayZ/mozaic/releases/tag/v0.7.0",
                ]
                statusCode = 200
            } else {
                body = [:]
    ...
    func stripsHiddenWrapperSectionsWithoutWhatsNewHeading() async {
        ...
        MockURLProtocol.requestHandler = { request in
            ...
            if url.path == "/repos/Ryz3nPlayZ/mozaic/releases/tags/v0.8.0" {
                body = [
                    "tag_name": "v0.8.0",
                    "name": "What's New in Mozaic 0.8.0",
                    "body": """
                    Brief summary

                    ## Installation

                    - Drag Mozaic to Applications

                    ## Verification

                    - SHA256: abc123
                    """,
                    "html_url": "https://github.com/Ryz3nPlayZ/mozaic/releases/tag/v0.8.0",
                ]
                statusCode = 200
            } else {
                body = [:]
