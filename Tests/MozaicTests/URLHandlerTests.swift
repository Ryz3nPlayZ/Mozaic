...
struct URLHandlerTests {
    ...
    @Test("Parse mozaic://play URL extracts video ID")
    func parseMozaicPlayURL() throws {
        let url = try #require(URL(string: "mozaic://play?v=abc123"))
        let result = URLHandler.parse(url)
    ...
    @Test("Parse mozaic://playlist URL extracts playlist ID")
    func parseMozaicPlaylistURL() throws {
        let url = try #require(URL(string: "mozaic://playlist?list=PLmylist"))
        let result = URLHandler.parse(url)
    ...
    @Test("Parse mozaic://album URL extracts album ID")
    func parseMozaicAlbumURL() throws {
        let url = try #require(URL(string: "mozaic://album?id=MPREb_album"))
        let result = URLHandler.parse(url)
    ...
    @Test("Parse mozaic://artist URL extracts artist ID")
    func parseMozaicArtistURL() throws {
        let url = try #require(URL(string: "mozaic://artist?id=UCchannel"))
        let result = URLHandler.parse(url)
