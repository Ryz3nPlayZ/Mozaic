...
// MARK: - MozaicUITestCase

/// Base class for Mozaic UI tests.
/// Provides common setup, launch configuration, and helper methods.
@MainActor
class MozaicUITestCase: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        // Create new app instance pointing to installed Mozaic.app
        let appURL = URL(fileURLWithPath: "/Applications/Mozaic.app")
        if FileManager.default.fileExists(atPath: appURL.path) {
            self.app = XCUIApplication(url: appURL)
        } else {
            self.app = XCUIApplication(bundleIdentifier: "com.zemuliu.Mozaic")
        }
